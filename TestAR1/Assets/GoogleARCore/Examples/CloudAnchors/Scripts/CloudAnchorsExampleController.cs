...
#pragma warning restore 618
        ...
        private void _InstantiateAnchorTwo()
        {

            GameObject.Find("LocalPlayer").GetComponent<LocalPlayerController>()
                .CmdSpawnAnchor(m_LastHitPose.Value.position, m_LastHitPose.Value.rotation, m_WorldOriginAnchor);
